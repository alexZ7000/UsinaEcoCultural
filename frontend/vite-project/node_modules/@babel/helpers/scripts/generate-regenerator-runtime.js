...
const [parse, generate] = await Promise.all([
  import("frontend/@babel/parser/typings/babel-parser.js").then(ns => ns.parse),
  import("frontend/@babel/generator/lib/index.js").then(ns => ns.default.default || ns.default),
]).catch(error => {
  console.error(error);
  throw new Error(
